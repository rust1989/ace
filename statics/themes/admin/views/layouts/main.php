...
<head>
    ...
    <?php $this->head() ?>
    <link href="/ace/statics/themes/admin/css/style.css" rel="stylesheet">
<body>
<?php $this->beginBody() ?>
...
<div class="left-side sticky-left-side">
    ...
    <div class="logo">
        <a href="index.html"><img src="/ace/statics/themes/admin/images/logo.png" alt=""></a>
    </div>

    <div class="logo-icon text-center">
        <a href="index.html"><img src="/ace/statics/themes/admin/images/logo_icon.png" alt=""></a>
    </div>
...
<?php $this->endBody() ?>
<script src="/ace/statics/themes/admin/js/jquery-ui-1.9.2.custom.min.js"></script>
<script src="/ace/statics/themes/admin/js/jquery.nicescroll.js"></script>
<script src="/ace/statics/themes/admin/js/scripts.js"></script>
</body>
</html>
<?php $this->endPage() ?>
